...
import {
    ...
    Coffee, ChevronDown, HandCoins, History, Users, Menu,
    Layers, ShieldCheck, Heart, PieChart, Receipt, PlusCircle
} from 'lucide-react'
                        ...
                        <details className="group relative z-40">
                            <summary className="list-none cursor-pointer marker:hidden [&::-webkit-details-marker]:hidden">
                                <div className="h-11 w-11 bg-bg2 border border-soft text-muted rounded-2xl flex items-center justify-center hover:bg-soft transition-all">
                                    <Menu size={16} className="group-open:text-figueira transition-colors" />
                                </div>
                            </summary>
                            <div className="absolute right-0 top-full mt-2 w-52 bg-bg border border-soft p-2 rounded-[1.5rem] shadow-2xl animate-in fade-in zoom-in-95 duration-200 flex flex-col gap-1 z-50">
                                ...
                                <Link href="/departamentos/cantina/dashboard" className="text-[10px] font-bold uppercase tracking-widest text-fg hover:bg-soft px-4 py-3 rounded-xl transition-all flex items-center gap-3">
                                    <Coffee size={13} className="text-orange-500" /> POS Cantina
                                </Link>
                                <Link href="/departamentos/cantina/despensa" className="text-[10px] font-bold uppercase tracking-widest text-fg hover:bg-soft px-4 py-3 rounded-xl transition-all flex items-center gap-3">
                                    <Heart size={13} className="text-pink-500" /> Ação Social
                                </Link>
